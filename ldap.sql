...
INSERT INTO ldap_entries VALUES (1, 'O=Enterprise', 3, 0, 1, NULL, NULL);
...
SELECT pg_catalog.setval('ldap_entries_id_seq', 3, true);
...
INSERT INTO ldapx_institutes VALUES (1, 'Вселенная', NULL, NULL);
...
SELECT pg_catalog.setval('ldapx_institutes_id_seq', 1, false);
